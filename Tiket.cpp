...
void head(){
 cout << "\t\t|===============================================|"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|      UJIAN AKHIR SEMESTER STRUKTUR DATA       |"<<endl;
 cout << "\t\t|APLIKASI PEMESANAN TIKET KERETA LINTAS UNIVERSE|"<<endl;
...
int main() {
 ...
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|\t[4] Menambah Data Penumpang             |"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|\t[5] Mencari Data Penumpang              |"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|\t[6] Menghapus Data Penumpang            |"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|\t[7] Menampilkan Data Penumpang          |"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|\t[8] Keluar                              |"<<endl;
 cout << "\t\t|                                               |"<<endl;
 cout << "\t\t|===============================================|"<<endl;
  ...
  cout << "\t\t|                                               |"<<endl;
      base = n;
      printf("\t\t|\tMasukkan nama (Tanpa Spasi) : ");scanf("%s", &base1);
  cout << "\t\t|                                               |"<<endl;
  cout << "\t\t|===============================================|"<<endl;
    enqueu(base, base1);
      n++;
  ...
  cout << endl;
     ...
     system("cls");
      nik++;
      head();
        cout << "\t\t| ID Pemesanan               : "; cin >> ktp[nik].nomor; cin.getline(get,1);
        cout << "\t\t| Nama Lengkap               : "; cin.getline(ktp[nik].nama,50);
        cout << "\t\t| No Hp                      : "; cin.getline(ktp[nik].agama,20);
        cout << "\t\t| Barang Bawaan              : "; cin.getline(ktp[nik].status,20);
        cout << "\t\t| Pekerjaan                  : "; cin.getline(ktp[nik].pekerjaan,20);
        cout << "\t\t| Kabupaten Asal             : "; cin.getline(ktp[nik].tempat,20);
        cout << "\t\t| Provinsi Tujuan            : "; cin.getline(ktp[nik].almt,20);
        cout << "\t\t| Kabupaten                  : "; cin.getline(ktp[nik].alamat.kel,20);
        cout << "\t\t| Kecamatan                  : "; cin.getline(ktp[nik].alamat.kec,20);
        cout << "\t\t| Kota                       : "; cin.getline(ktp[nik].alamat.kota,20);
        cout << "\t\t| Harga Tiket                : "; cin.getline(ktp[nik].tanggal,20);
  ...
  cout << endl;
     ...
     for(x=0;x<=nik;x++) {
       if(namedit==ktp[x].nomor) {
        ...
        cout << "\t\t|\tRegistrasi data penumpang ke-" << x+1 <<"          |"<< endl;
        cout << "\t\t|                                               |"<<endl;
          cout << "\t\t|\tNama Lengkap      : " << ktp[x].nama<<"                  |" << endl;
          cout << "\t\t|\tNo Hp             : " << ktp[x].agama<<"                  |" << endl;
          cout << "\t\t|\tBarang Bawaan     : " << ktp[x].status<<"                  |" << endl;
          cout << "\t\t|\tPekerjaan         : " << ktp[x].pekerjaan<<"                  |" << endl;
          cout << "\t\t|\tKabupaten Asal    : " << ktp[x].tempat<<"                  |" << endl;
          cout << "\t\t|\tProvinsi Tujuan   : "<< ktp[x].almt<<"                  |" << endl;
          cout << "\t\t|\tKabupaten         : "<< ktp[x].alamat.kel<<"                  |" << endl;
          cout << "\t\t|\tKecamatan         : "<< ktp[x].alamat.kec<<"                  |" << endl;
          cout << "\t\t|\tKota              : "<< ktp[x].alamat.kota<<"                  |" << endl;
          cout << "\t\t|\tHarga Tiket       : "<< ktp[x].tanggal<<"                  |" << endl;
  ...
  cout << "\t\t|===============================================|"<<endl;
  cout << "\t\t|                                               |"<<endl;
  cout << "\t\t|    DATA PENUMPANG   TIDAK DI TEMUKAN !!!   |"<<endl;
        menu0:
  cout << "\t\t|                                               |"<<endl;
  cout << "\t\t|===============================================|"<<endl;
  cout << "\t\t|                                               |"<<endl;
  ...
  cout << endl;
     ...
     system ("cls");
  head();
  cout << "\t\t|    PENGHAPUSAN DATA PELANGGAN PADA DATABASE   |"<<endl;
  cout << "\t\t|                                               |"<<endl;
  cout << "\t\t|===============================================|"<<endl;
  cout << "\t\t|                                               |"<<endl;
     cout << "\t\t|\tID Pemesanan : "; cin >> namedit;
  ...
  cout << "\t\t|===============================================|"<<endl;
    ...
    system ("cls");
    head();
  		cout << "\t\t|           MENAMPILKAN DATA PENUMPANG          |"<<endl;
        cout << "\t\t|                                               |"<<endl;
 	    cout << "\t\t|===============================================|"<<endl;
        cout << "\t\t|                                               |"<<endl;
    for(x=0;x<=nik;x++) {
        cout << "\t\t|\tDatabase Data Penumpang ke-" << x+1 <<"            |" <<endl;
        cout << "\t\t|                                               |"<<endl;
        cout << "\t\t|\tID_Pemesanan   : " << ktp[x].nomor<<"                     |" << endl;
  ...
  cout << "\n\tMasukan Pilihan Anda : "; cin >> prio;
   ...
   if(prio == 1) {
       ...
       cout << " ID  tersebut Tidak Priorty"<<endl;
       system("pause");
       goto quit;
    }
     }
